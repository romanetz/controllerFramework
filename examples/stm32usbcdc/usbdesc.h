...
static const USBDeviceDescr deviceDescr = {
	.bLength = sizeof(USBDeviceDescr),
...
static const struct {
	USBConfigDescr descr;
	USBInterfaceDescr iface0descr;
	uint8_t cdcData[19];
	USBEndpointDescr endpoint1descr;
	USBInterfaceDescr iface1descr;
	USBEndpointDescr endpoint1outDescr;
	USBEndpointDescr endpoint1inDescr;
} __attribute__((packed)) usbConfig1 = {
	{
		.bLength = sizeof(USBConfigDescr),
	...
	{
		.bLength = sizeof(USBInterfaceDescr),
	...
	{
		.bLength = sizeof(USBEndpointDescr),
...
static const USBConfigDescr *usbConfigs[] = {
	&usbConfig1.descr
};
...
static const USBStringDescr *usbStrings[] = {
	&usbString0.descr,
	&usbString1.descr,
	&usbString2.descr,
	&usbString3.descr
