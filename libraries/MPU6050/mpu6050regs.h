#ifndef MPU6050DEFS_H
#define MPU6050DEFS_H
...
/*
	These declarations of constants taken from the example sketch
	for Arduino from URL http://playground.arduino.cc/Main/MPU-6050#sketch
*/
